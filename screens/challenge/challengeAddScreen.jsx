	...
	const confirmHandle = (time) => {
		...
		Notifications.scheduleNotificationAsync({
			content: {
				...
				body: `${(Number(format(new Date(time), 'H', { locale: ko, format: 'HH:mm:ss' })))} : ${(Number(format(new Date(time), 'm', { locale: ko, format: 'MM:dd HH:mm' })))} 시간으로 알림설정 되었습니다.`,
			},
		...
		console.log(Number(format(new Date(time), 'm', { locale: ko, format: 'MM:dd HH:mm' })));
